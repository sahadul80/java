...
System.out.print("	Enter Student ID: ");
id=sc.next();
frw.writeInFile("		Mr. "+s.getName()+", ID: "+s.getId()+" Has requested to Cancell Registration.\n");
System.out.println("	Your Registration will be cancelled within 24 hours.\n");
...
{
System.out.println("	Please Regisrer to AIUB Automated Food & Braverage Service First!\n");
}
break;					
case 4:
